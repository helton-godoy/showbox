...
| SB-006 | Proteção Git remota e transição dos repositórios antigos | SB-005 | Em execução (aguarda SB-006A) |
| SB-006A | Correção: segurança de abertura/salvamento e validação de projeto | SB-005 | Em execução |
