...
- `conductor/` — approximately 43 files
- `core.1/` — approximately 1 files
- `docs/` — approximately 4 files
- `GEMINI.md/` — approximately 1 files
- `packaging/` — approximately 4 files
- `README.md/` — approximately 1 files
- `scripts/` — approximately 9 files
- `src/` — approximately 22 files
