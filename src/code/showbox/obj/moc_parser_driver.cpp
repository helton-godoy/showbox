...
#include "../legacy/v2_incomplete/parser_driver.h"
...
const QMetaObject *ParserDriver::metaObject() const
{
...
int ParserDriver::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
